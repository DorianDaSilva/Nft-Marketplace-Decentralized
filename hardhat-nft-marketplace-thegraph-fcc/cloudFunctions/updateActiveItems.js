        ...
        if (alreadyListedItem) {
            ...
            logger.info(
                `Deleted item with tokenId ${request.object.get(
                    "tokenId"
                )} at address ${request.object.get("address")} since it's been listed`
            )
        }
...
Moralis.Cloud.afterSave("ItemCanceled", async (request) => {
    ...
    if (confirmed) {
        ...
        logger.info(`Marketplace | CaneledItem: ${canceledItem}`)
        if (canceledItem) {
            logger.info(
            ...
            logger.info(
                `No item found with address ${reequest.object.get(
                    "address"
...
Moralis.Cloud.afterSave("ItemBought", async (request) => {
    ...
    if (confirmed) {
        ...
        if (boughtItem) {
            ...
            logger.info(
                `Delete item with Token ID ${request.object.get(
                    "tokenId"
